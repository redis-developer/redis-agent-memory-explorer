...
- [Suggestions Plan](./dev-suggestions-brainstorm.md) -- push-based AI copilot with suggestion endpoint + in-memory store (new `generateSuggestion` + `listSuggestions` routes)
